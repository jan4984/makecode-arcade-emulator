...
pub type retro_hw_render_interface_type = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type retro_hw_render_context_negotiation_interface_type = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type retro_sensor_action = u32;
...
pub type retro_camera_buffer = u32;
...
pub type retro_rumble_effect = u32;
...
pub type retro_hw_context_type = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type retro_pixel_format = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type retro_message_target = u32;
...
pub type retro_message_type = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_retro_throttle_state() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<retro_throttle_state>())).mode as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<retro_throttle_state>())).rate as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(retro_throttle_state),
